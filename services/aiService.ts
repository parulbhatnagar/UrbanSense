 ...
 * See MODEL_SWAP_GUIDE.md for detailed instructions.
 */
...
class GeminiImageAnalysisService implements ImageAnalysisService {
  ...
  constructor() {
    ...
    if (!geminiConfig.apiKey || geminiConfig.apiKey === "YOUR_API_KEY") {
      throw new Error("API_KEY environment variable not set for Gemini. Please configure it in index.html.");
    }
